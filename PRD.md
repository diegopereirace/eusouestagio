...
- Composição `/para-empresas` em `content_full` (weights 0–4, só essa URL; placements home 004–006 intocados): `nossos_diferenciais` **mesma instância da home** (UUID `b0a1c2d3-…`, placement `default_nossosdiferenciaisparaempresas`) → `nossa_metodologia` **mesma instância da home** (UUID `1f9b40ca-…`, placement `default_nossametodologiaparaempresas`) → `o_que_fazemos_bt` (`e5f6a7b8-…`) → Benefícios via reuso `diferenciais_quem_somos` título “Benefícios para Empresas” (`f6a7b8c9-…`) → `cta_v1` “Pronto para contratar os melhores talentos?” (`a7b8c9d0-…`, links `/cadastro/empresa` + `/painel/empresa/vagas/nova`). Seed + limpeza do Node shell: `11024`; reuso Diferenciais: `11025`; reuso Metodologia: `11026`.
